...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_controller_v1_0_S00_AXI is
  ...
  signal \NLW_counter_reg[25]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_counter_reg[25]_i_3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute ADDER_THRESHOLD of \counter_reg[25]_i_3\ : label is 35;
...
LAT_O_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
LAT_O_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
LAT_O_i_8: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\counter[10]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EFFFFFFE00000000"
    )
        port map (
      I0 => \^counter_reg[9]_0\,
      I1 => \counter[25]_i_2_n_0\,
      I2 => \^q\(0),
      I3 => \counter_reg_n_0_[2]\,
...
\counter_reg[25]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => \counter_reg[24]_i_2_n_0\,
      CO(3 downto 0) => \NLW_counter_reg[25]_i_3_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_counter_reg[25]_i_3_O_UNCONNECTED\(3 downto 1),
      O(0) => data0(25),
      S(3 downto 1) => B"000",
...
LAT_O_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF770003"
        ...
        port map (
      I0 => matrix_controller_v1_0_S00_AXI_inst_n_42,
      I1 => matrix_controller_v1_0_S00_AXI_inst_n_7,
      I2 => matrix_controller_v1_0_S00_AXI_inst_n_41,
      I3 => matrix_controller_v1_0_S00_AXI_inst_n_40,
      I4 => \^lat\,
      O => LAT_O_i_2_n_0
    );
