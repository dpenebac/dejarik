...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_controller_v1_0_S00_AXI is
  ...
  signal LAT_O_i_3_n_0 : STD_LOGIC;
  signal LAT_O_i_4_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of LAT_O_i_2 : label is "soft_lutpair0";
...
LAT_O_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E1"
    )
        port map (
...
LAT_O_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
LAT_O_i_9: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute X_INTERFACE_INFO of clk_40mhz : signal is "xilinx.com:signal:clock:1.0 CLK_40MHZ CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk_40mhz : signal is "XIL_INTERFACENAME CLK_40MHZ, FREQ_HZ 40000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_1_clk_out1, INSERT_VIP 0";
