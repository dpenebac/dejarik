...
LAT_O_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
LAT_O_reg: unisim.vcomponents.FDCE
     port map (
      C => clk_40mhz,
      CE => '1',
      CLR => SR(0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_controller_v1_0 is
  ...
  signal matrix_controller_v1_0_S00_AXI_inst_n_4 : STD_LOGIC;
...
begin
  ...
  s00_axi_rvalid <= \^s00_axi_rvalid\;
LAT_O_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
aw_en_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => s00_axi_awvalid,
      I4 => s00_axi_wvalid,
      I5 => matrix_controller_v1_0_S00_AXI_inst_n_4,
      O => aw_en_i_1_n_0
    );
...
matrix_controller_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_controller_v1_0_S00_AXI
     port map (
      SR(0) => LAT_O_i_2_n_0,
      aw_en_reg_0 => matrix_controller_v1_0_S00_AXI_inst_n_4,
