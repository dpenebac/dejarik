...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_controller_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \counter[24]_i_1\ : label is "soft_lutpair11";
...
LAT_O_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
LAT_O_i_2: unisim.vcomponents.LUT6
    generic map(
...
LAT_O_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
