...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_controller_v1_0_S00_AXI is
  port (
    ...
    \counter2_reg[22]_0\ : out STD_LOGIC;
    \counter2_reg[0]_0\ : out STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    LAT_O_reg_0 : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_controller_v1_0_S00_AXI is
  signal LAT_O_i_10_n_0 : STD_LOGIC;
  signal LAT_O_i_11_n_0 : STD_LOGIC;
  signal LAT_O_i_12_n_0 : STD_LOGIC;
  signal LAT_O_i_13_n_0 : STD_LOGIC;
  signal LAT_O_i_14_n_0 : STD_LOGIC;
  signal LAT_O_i_6_n_0 : STD_LOGIC;
  signal LAT_O_i_7_n_0 : STD_LOGIC;
  signal LAT_O_i_8_n_0 : STD_LOGIC;
  signal LAT_O_i_9_n_0 : STD_LOGIC;
  ...
  signal counter2_reg : STD_LOGIC_VECTOR ( 25 downto 0 );
  ...
  signal \^counter2_reg[22]_0\ : STD_LOGIC;
  ...
  signal \^counter_reg[16]_0\ : STD_LOGIC;
  ...
  signal \NLW_counter2_reg[24]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_counter2_reg[24]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_counter_reg[25]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_counter_reg[25]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute ADDER_THRESHOLD of \counter2_reg[0]_i_2\ : label is 11;
  ...
  attribute ADDER_THRESHOLD of \counter2_reg[24]_i_1\ : label is 11;
  ...
  attribute ADDER_THRESHOLD of \counter_reg[25]_i_2\ : label is 35;
...
begin
  ...
  \counter2_reg[22]_0\ <= \^counter2_reg[22]_0\;
  \counter_reg[16]_0\ <= \^counter_reg[16]_0\;
  s00_axi_rvalid <= \^s00_axi_rvalid\;
LAT_O_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
LAT_O_i_10: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
LAT_O_i_11: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
LAT_O_i_12: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
LAT_O_i_13: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
LAT_O_i_14: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
LAT_O_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => counter2_reg(25),
      I5 => counter2_reg(24),
      O => \^counter2_reg[22]_0\
    );
LAT_O_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000080"
    )
        port map (
...
LAT_O_i_5: unisim.vcomponents.LUT6
    generic map(
...
LAT_O_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
LAT_O_i_7: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
LAT_O_i_8: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
LAT_O_i_9: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
...
LAT_O_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => LAT_O_reg_0,
...
\counter2[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000008000"
    )
        port map (
      I0 => LAT_O_i_8_n_0,
      I1 => \^counter2_reg[22]_0\,
      I2 => LAT_O_i_7_n_0,
      I3 => LAT_O_i_6_n_0,
      I4 => counter2_reg(0),
      I5 => counter2_reg(1),
...
\counter2_reg[24]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_counter2_reg[24]_i_1_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \counter2_reg[24]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_counter2_reg[24]_i_1_O_UNCONNECTED\(3 downto 2),
      O(1) => \counter2_reg[24]_i_1_n_6\,
      O(0) => \counter2_reg[24]_i_1_n_7\,
      S(3 downto 2) => B"00",
      S(1 downto 0) => counter2_reg(25 downto 24)
    );
...
\counter_reg[25]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW_counter_reg[25]_i_2_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_counter_reg[25]_i_2_O_UNCONNECTED\(3 downto 1),
      O(0) => data0(25),
      S(3 downto 1) => B"000",
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_controller_v1_0 is
  signal LAT_O_i_2_n_0 : STD_LOGIC;
  ...
  signal matrix_controller_v1_0_S00_AXI_inst_n_5 : STD_LOGIC;
  signal matrix_controller_v1_0_S00_AXI_inst_n_7 : STD_LOGIC;
  signal matrix_controller_v1_0_S00_AXI_inst_n_8 : STD_LOGIC;
...
begin
  ...
  s00_axi_rvalid <= \^s00_axi_rvalid\;
LAT_O_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"777F8880"
    )
        port map (
      I0 => matrix_controller_v1_0_S00_AXI_inst_n_41,
      I1 => matrix_controller_v1_0_S00_AXI_inst_n_42,
      I2 => matrix_controller_v1_0_S00_AXI_inst_n_7,
      I3 => matrix_controller_v1_0_S00_AXI_inst_n_8,
      I4 => \^lat\,
      O => LAT_O_i_2_n_0
    );
aw_en_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => s00_axi_awvalid,
      I4 => s00_axi_wvalid,
      I5 => matrix_controller_v1_0_S00_AXI_inst_n_5,
      O => aw_en_i_1_n_0
    );
...
matrix_controller_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_controller_v1_0_S00_AXI
     port map (
      LAT_O_reg_0 => LAT_O_i_2_n_0,
      Q(0) => matrix_controller_v1_0_S00_AXI_inst_n_7,
      aw_en_reg_0 => matrix_controller_v1_0_S00_AXI_inst_n_5,
      ...
      \counter2_reg[0]_0\ => matrix_controller_v1_0_S00_AXI_inst_n_42,
      \counter2_reg[22]_0\ => matrix_controller_v1_0_S00_AXI_inst_n_41,
      \counter_reg[16]_0\ => matrix_controller_v1_0_S00_AXI_inst_n_8,
      lat => \^lat\,
