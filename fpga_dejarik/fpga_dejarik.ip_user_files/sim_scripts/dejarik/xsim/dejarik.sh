...
#
# Generated by Vivado on Sat Jan 06 12:16:52 -1000 2024
...
{
  file="xsim.ini"
  lib_map_path="C:/Users/peneb/Desktop/FPGA/Vivado/2022.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dejarik.wdb xsim.dir)
