...
#
# Generated by export_simulation on Sat Jan 06 12:16:52 -1000 2024
#
################################################################################
...
'-reset_run' switch to the './dejarik.sh' script.

./dejarik.sh -reset_run
...
./dejarik.sh -noclean_files

For more information on the script, please type './dejarik.sh -help'.
